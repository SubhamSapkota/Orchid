    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-red-800 mb-8">Get In Touch</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+977-9842612791<br /> 046-530654 (Admissions)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sunday - Friday: 8:00 AM - 5:00 PM<br /> <br /><span className="text-red-800">Saturday: Closed</span></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-red-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-red-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
              </form>
      ...
      {/* Map Container */}
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <h2 className="text-3xl font-bold text-yellow-500 mb-3">Find Us</h2>
            <p className="text-lg text-gray-600">Visit our <span className = "text-2xl font-bold text-red-800">School</span> and experience our facilities firsthand</p>
          </div>
            ...
            <div className="p-4 bg-gray-60 border-t">
              <p className="text-m text-red-800 text-center">
      ...
      {/* CTA Section */}
      <div className="py-16 bg-gradient-to-r from-yellow-500 to-yellow-800">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-red-800 mb-4">Ready to Visit Our Campus?</h2>
          <p className="text-xl text-red-100 mb-8">
            Schedule a campus tour and see why Orchid English Secondary School is the right choice for your education.
          </p>
          <div className="space-x-4">
            <button className="bg-white text-red-800 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 shadow-lg">
              Schedule a Tour
            </button>
            <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-800 transition-colors duration-300">
              Call Us Now
            </button>
          </div>
        </div>
